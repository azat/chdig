...
memory with usage bars, running queries, threads, network and disk rates); it
takes a third of the screen by default, **[**/**]** or dragging its bottom separator resize it,
