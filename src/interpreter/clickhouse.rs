...
impl ClickHouse {
    ...
    pub async fn get_replication_queue(&self) -> Result<Columns> {
        let dbtable = self.get_table_name("system.replication_queue");
        return self
            .execute(
                format!(
                    r#"
    ...
    pub async fn get_replicated_fetches(&self) -> Result<Columns> {
        let dbtable = self.get_table_name("system.replicated_fetches");
        return self
            .execute(
                format!(
                    r#"
    ...
    pub async fn get_replicas(&self) -> Result<Columns> {
        let dbtable = self.get_table_name("system.replicas");
        return self
            .execute(
                format!(
                    r#"
