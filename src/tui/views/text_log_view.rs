...
use crate::tui::views::log_store::LogEntry;
use crate::tui::views::log_view::LogView;
...
impl TextLogView {
    pub fn new(view_name: &'static str, context: ContextArc, args: TextLogArguments) -> Self {
        ...
        let (delay, is_cluster, wrap, no_strip_hostname_suffix, descending, align_columns) = {
            ...
            (
                ...
                ctx.options.view.align_log_columns,
            )
        };
...
impl Component for TextLogView {
    ...
    fn on_event(&mut self, event: &Event) -> EventResult {
        self.inner_view.on_event(event)
    }
